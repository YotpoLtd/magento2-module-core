...
class ErrorHandler
{
    ...
    public function handleConflictResponse($entityId, $entityTypeInYotpoApi, $entityDataToSync, $parentTypeInYotpoApi = null, $parentYotpoId = null)
    {
        ...
        return $this->updateExistingEntityInYotpo($patchEndpointUrl, $entityDataToSync);
    }
    ...
    public function handleNotFoundResponse($entityId, $entityTypeInYotpoApi, $entityDataToSync, $parentTypeInYotpoApi = null, $parentYotpoId = null)
    {
        ...
        if ($entityYotpoId == 0) {
            ...
            return $this->createEntityInYotpo($postEndpointUrl, $entityDataToSync);
        }
    ...
    private function createEntityInYotpo($postEndpointUrl, $entityDataToSync) {
        return $this->coreSync->sync($this->config::METHOD_POST, $postEndpointUrl, $entityDataToSync);
    }

    private function updateExistingEntityInYotpo($patchEndpointUrl, $entityDataToSync) {
        return $this->coreSync->sync($this->config::METHOD_PATCH, $patchEndpointUrl, $entityDataToSync);
    }
}
